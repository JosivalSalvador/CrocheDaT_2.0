      ...
      <main className="relative z-10 container mx-auto px-3 py-12 sm:px-4 md:py-20">
        ...
        <header className="animate-in fade-in slide-in-from-top-4 mb-10 flex flex-col items-center text-center duration-700 md:mb-14">
          ...
          <p className="text-muted-foreground mt-3 max-w-xl text-base text-balance md:text-lg">
            ...
            {currentCategory?.name.toLowerCase() || "peças"}. Feito à mão, sem
            frescura e com muita identidade para o seu dia a dia.
          </p>
        </header>

        {/* Central de Filtros: CategoryNav + Busca Fluida */}
        <div className="animate-in fade-in mb-12 flex flex-col items-center gap-6 delay-150 duration-700 md:mb-16 md:gap-8">
          <div className="w-full max-w-5xl">
            <CategoryNav />
          </div>

          {/* Barra de Busca Corrigida (Sem bugar ícones) */}
          <div className="relative w-full max-w-md">
            {/* Ícone fixo com z-10 para não ser engolido pelo input */}
        ...
        {/* Listagem / Grid Extremamente Responsivo */}
        {isLoading ? (
